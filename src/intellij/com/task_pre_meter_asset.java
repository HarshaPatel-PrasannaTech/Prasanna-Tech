 ...
 */ 
public class task_pre_meter_asset implements Runnable{
      public task_pre_meter_asset(String input, String url, String authString) {
        this.input = input;
        this.url = url;
...
//          output = resp.getEntity(String.class);
            ...
            output="{\"response\":\"Success\",\"status_code\":201,\"message\":\"Asset Creation for device ID :: PolarisAS214790 successfully saved.\"}";
