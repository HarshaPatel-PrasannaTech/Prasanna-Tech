 ...
 */
public class NewTrywithExtradoublequotes {
    public static void main(String[] args) throws IOException, Exception {
        ...
        try {
            ...
            try (FileWriter writer = new FileWriter(csvFile)) {
                ...
                System.out.println("Error occurred while writing the CSV: " + e);
            } finally {
                if (rs != null) try { rs.close(); } catch (SQLException e) { System.out.println("Error closing ResultSet: " + e); }
                if (stmt != null) try { stmt.close(); } catch (SQLException e) { System.out.println("Error closing Statement: " + e); }
                if (con != null) try { con.close(); } catch (SQLException e) { System.out.println("Error closing Connection: " + e); }
            }
