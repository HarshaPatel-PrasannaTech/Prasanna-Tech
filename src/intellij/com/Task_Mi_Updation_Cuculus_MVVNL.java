 ...
 */
public class Task_Mi_Updation_Cuculus_MVVNL implements Runnable{
     public Task_Mi_Updation_Cuculus_MVVNL(String input, String url, String authString, String meter_no) {
        this.input = input;
        this.url = url;
    ...
    public void runservice(String url, String authString) throws JSONException, Exception {
        ...
        try {
           ...
           //String output =  "{\"Device_Id\": \"AL567989\", \"httpStatusCode\": 201, \"httpStatus\": \"Installed\", \"message\": \"Following Endpoint is Installed\"}";
...
//            builder.header("JWT", "Bearer wfm_key_mgvcl@@eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ3Zm1fa2V5X21ndmNsIiwicHJvZHVjdCI6IndmbV9rZXlfbWd2Y2wifQ.oilrlD5vVXaYgq83BGoe8RY0gjr0nFGj-0lO1RHkLU8MxG6oH0xYxltaTrzAT7WOploqzTajrjdstl6M4ulbXg");
            // TEST JWT
//builder.header("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InN0eXJhLXdmbS1tZG1zLWludGVncmF0aW9uIn0.G1yKoHoFUNiAMuq1TtevKEDKKyc9rZZC-MrJUY8AEWw");
...
if(jsnObject.has("httpStatusCode")&&jsnObject.has("httpStatus")){
                if (jsnObject.getString("httpStatus").equals("Installed")) {
...
//        updateStmt.executeUpdate();
        ...
        String insertQuery = "INSERT INTO tp_deviceregistration_meterinstall_logs (trackid,  responsemsg, searial_no, status, input, type) VALUES (?, ?,  ?, ?, ?, 'JIO')";
