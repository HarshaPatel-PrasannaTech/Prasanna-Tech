 ...
 */
public class Task_Mi_Updation_Cuculus_DGVCL implements Runnable{
      public Task_Mi_Updation_Cuculus_DGVCL(String input, String url, String authString, String meter_no) {
        this.input = input;
        this.url = url;
...
//        updateStmt.executeUpdate();
        ...
        String insertQuery = "INSERT INTO tp_deviceregistration_meterinstall_logs (trackid,  responsemsg, searial_no, status, input, type) VALUES (?, ?,  ?, ?, ?, 'Cuculus')";
